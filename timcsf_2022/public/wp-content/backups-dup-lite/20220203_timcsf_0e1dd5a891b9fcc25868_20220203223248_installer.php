...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220203_timcsf_0e1dd5a891b9fcc25868_20220203223248_archive.zip';
	const ARCHIVE_SIZE		 = '19068041';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '0e1dd5a-03223248';
    const SECONDARY_PACKAGE_HASH = 'a84bc5b-03223248';
	const VERSION			 = '1.4.4';
